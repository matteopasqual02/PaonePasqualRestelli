...
\section{Scope}
Students\&Companies (S\&C) is a platform that aims to connect students looking for internships with companies that offer them. 
Companies can advertise their open internship positions and receive recomendation about possible candidates, while students can search for opportunities both in a proactive way, looking through alerts, and in a passive way, they are notified by the system when a job offer corresponds to their criteria. 
This matchmaking process, in case of acceptance by both the parts involved, is followed by the interview process, in which companies are supported by the system  
\textit{(devo finire)
}
...
\textbf{[SP8]} Universities handle complaints
